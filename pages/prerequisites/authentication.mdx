...
Look for the Cookie labeled `__Secure-1PSID` **_exactly_**, and copy it. Now, use this cookie whenever `COOKIE_KEY` is referred to in the documentation. (`bard-ai` will not work with any other cookie.)
